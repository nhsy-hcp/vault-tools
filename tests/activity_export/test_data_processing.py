...
class TestReadJson:
    ...
    def test_read_json_file_not_found(self):
        ...
        with patch("builtins.open", side_effect=FileNotFoundError), pytest.raises(FileProcessingError, match="Failed to read or parse"):
            read_json("nonexistent.json")

    def test_read_invalid_json(self):
        """Test reading invalid JSON file."""
        with patch("builtins.open", mock_open(read_data="invalid json")), pytest.raises(FileProcessingError, match="Failed to read or parse"):
